...
export const kpis = [
  ...
  { cat: 'fin', icon: 'Trash2',        title: 'Revenue Yield per Tonne',  formula: '(Total revenue generated from operaitons / Total recyclable material recovered) × 100',              desc: 'o	Lower-quality outputs, weak buyer linkages, or sale of unprocessed material typically reduce revenue yield.',               bands: [['g','> 90%','Superior'],['a','80–90%','Med'],['r','< 80%','Poor']] },
  ...
  { cat: 'fin',  icon: 'IndianRupee',   title: 'Cost per Tonne',          formula: 'Total OPEX / Weight of recovered material',                   desc: 'Fundamental unit economics metric. Includes labour, transport, energy, and maintenance costs.',                             bands: [['g','90-100%','Eff'],['a','100-120%','Avg'],['r','> 120%','High']] },
  ...
  { cat: 'comp', icon: 'FileCheck',     title: 'Doc Completeness',     formula: 'Degree of records updated, including presence and severity of audit findings',              desc: 'Traceability for ULB reporting and EPR compliance. Gaps make it impossible to prove impact.',                               bands: [['g','All updated with no material findings','Audit'],['a','Minor delays; limited corrective findings','Gaps'],['r','Major gaps and findings','Risk']] },
