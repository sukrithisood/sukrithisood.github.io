...
export const kpis = [
  ...
  { cat: 'fin', icon: 'Trash2',        title: 'Revenue Yield per Tonne',  formula: '(Total revenue generated from operations / Total recyclable material recovered) × 100',              desc: 'o	Lower-quality outputs, weak buyer linkages, or sale of unprocessed material typically reduce revenue yield.',               bands: [['g','> 90%','Superior'],['a','80–90%','Med'],['r','< 80%','Poor']] },
